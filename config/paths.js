...
const appAliases = {
  '@images': resolveApp('src/static/images'),
  '@client': resolveApp('src/client'),
  '@elements': resolveApp('src/client/components/elements'),
  '@pages': resolveApp('src/client/components/pages'),
  '@actions': resolveApp('src/client/redux/actions'),
}
